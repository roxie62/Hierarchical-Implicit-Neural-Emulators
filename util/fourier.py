...
class SpectralConv2dSteerable(nn.Module):
    ...
    def __init__(self, in_channels: int, out_channels: int, modes1: int, modes2: int):
        ...
        self.weights1 = nn.Parameter(
            self.scale * torch.rand(in_channels, self.modes1, self.modes2, 2, dtype=torch.float32)
        )
    ...
    def forward(self, x, x_dim=None, y_dim=None):
        ...
        out_ft[:, :, : self.modes1, : self.modes2] = batchmul2ds(
